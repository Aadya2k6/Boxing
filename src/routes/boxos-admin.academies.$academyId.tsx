        ...
        <div className="animate-fade-up">
          ...
          {activeTab === "revenue" && (
            <SectionCard title="Invoices & Revenue" subtitle="List of all invoices generated by this academy">
              <div className="mb-6 p-4 rounded-xl bg-fuchsia-600/10 border border-fuchsia-600/25 flex items-center justify-between">
                <div>
                   <div className="text-sm font-semibold text-fuchsia-600 mb-1">Current Monthly Revenue</div>
                   <div className="text-2xl font-display font-bold text-foreground">₹{stats.monthlyRevenue.toLocaleString("en-IN")}</div>
                </div>
                <CreditCard className="size-8 text-fuchsia-600/50" />
              </div>
              <DataTable
